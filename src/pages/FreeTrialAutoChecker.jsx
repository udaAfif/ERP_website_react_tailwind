    ...
    <>
      ...
      >
        ...
        <h2 className="text-4xl text-center text-[#5F7CDD] font-semibold mb-5">
          Got any special request? Ask away!
        </h2>
        <h2 className="text-2xl text-center text-black font-medium mb-5">
          Our dedicated staff is here to provide you with the information and
          assistance you need, whether you have <br /> questions about our
          products, services, or policies. From technical support to product
          recommendations.
        </h2>
...
export default FreeTrialAutoChekcer;
