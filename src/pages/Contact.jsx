            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-5">
              <div className="mt-5 ">
                ...
                <div className="flex text-sm font-normal mt-3">
                  ...
                  (Indonesia) 0812-9714-3247 <br />
                  (Global) +82 10-5597-5330
                </div>
                <div className="flex text-sm font-normal mt-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  (Indonesia) Contact@wecruitasia.com <br />
                  (Global) wecruit@wecruitcorp.com
                </div>
              </div>
              ...
              <div className="mt-5">
                ...
                <div className="flex text-sm font-normal mt-3">
                  ...
                  (CHECKER) +82 031-548-6715 <br />
                  (Marketing) +82 031-778-6710
                </div>
                <div className="flex text-sm font-normal mt-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  wecruit@wecruitcorp.com <br /> (CHECKER)
                  checker@wecruitcorp.com
                </div>
              </div>
            </div>
          </div>
