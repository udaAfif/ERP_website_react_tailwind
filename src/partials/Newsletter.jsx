              ...
              <div className="text-center lg:text-left lg:max-w-xl mx-10">
                ...
                <form className="w-full lg:w-auto">
                  <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-md lg:mx-0">
                    <input
                      type="email"
                      className="form-input w-full rounded-md appearance-none bg-white border border-[#5F7CDD] focus:border-blue-600  px-4 py-3 mb-2 sm:mb-0 sm:mr-2  placeholder-gray-500"
